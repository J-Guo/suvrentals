        ...
        <div class="content-body">
          <div class="row">
                ...
                <div class="panel-body">
                  <form role="form" id="basic-validate">
                    <div class="form-group">
                      <label class="control-label" for="basicName">Text</label>
                      <input class="form-control" name="basicText" id="basicText"> </div>
                    <!-- /.form-group -->
                    <div class="form-group">
                      <label class="control-label" for="basicPasswd">Password</label>
                    ...
                    <!-- /.form-group -->
                    <div class="form-group">
                      <label class="control-label" for="basicSelect">Select</label>
                      <label class="select select-o">
                        <select id="basicSelect" name="basicSelect">
                    ...
                    <!-- /.form-group -->
                    <div class="form-group">
                      <label class="control-label" for="basicFile">File</label>
                      <input id="basicFile" class="form-control" name="basicFile" type="file" accept="image/*"> </div>
                    <!-- /.form-group -->
                    <div class="form-group">
                      <label class="control-label">Checkbox</label>
                      <div class="nice-checkbox">
                        <input type="checkbox" id="basicAgree" name="basicAgree">
                        <label for="basicAgree">Please agree to our policy</label>
                      </div>
                    </div>
                    <!-- /.form-group -->
            ...
            <div class="col-md-6">
              <div class="panel" data-fill-color="true">
                <div class="panel-heading">
                  <div class="panel-control-input pull-right">
                    <div id="indicator-fills" class="progress progress-striped">
                      <span class="progress-bar"></span>
                    </div>
                  </div>
                  <h3 class="panel-title">Validation state icon</h3>
                </div>
                <div class="panel-body">
                  <form role="form" id="state-validate">
                    <div class="form-group has-feedback">
                      <label class="control-label" for="stateName">Text</label>
                      <input class="form-control" name="stateText" id="stateText">
                      <span class="form-control-feedback"></span>
                    </div><!-- /.form-group -->
                    <div class="form-group has-feedback">
                      <label class="control-label" for="stateEmail">Email</label>
                      <input id="stateEmail" class="form-control" name="stateEmail" type="email">
                      <span class="form-control-feedback"></span>
                    </div><!-- /.form-group -->
                    <div class="form-group has-feedback">
                      <label class="control-label" for="stateUrl">URL</label>
                      <input id="stateUrl" class="form-control" name="stateUrl" type="url">
                      <span class="form-control-feedback"></span>
                      <div class="help-block">e.g: http://strilearning.com</div>
                    </div><!-- /.form-group -->
                    <div class="form-group has-feedback">
                      <label class="control-label" for="stateNumber">Number (allow decimal)</label>
                      <input id="stateNumber" class="form-control" name="stateNumber">
                      <span class="form-control-feedback"></span>
                    </div><!-- /.form-group -->
                    <div class="form-group has-feedback">
                      <label class="control-label" for="stateDigits">Digits</label>
                      <input id="stateDigits" class="form-control" name="stateDigits">
                      <span class="form-control-feedback"></span>
                    </div><!-- /.form-group -->
                    <div class="form-group has-feedback">
                      <label class="control-label" for="stateCard">Credit Card</label>
                      <input id="stateCard" class="form-control" name="stateCard">
                      <span class="form-control-feedback"></span>
                      <div class="help-block">e.g: 6000 0000 0000 004</div>
                    </div><!-- /.form-group -->
                    <div class="form-group clearfix">
                      <div class="pull-right">
                        <button type="reset" class="btn btn-default">Reset</button>
            ...
            <div class="col-md-6">
              <div class="panel" data-fill-color="true">
                <div class="panel-heading">
                  <h3 class="panel-title">Advance elements</h3>
                </div>
                <div class="panel-body">
                  <form role="form" id="adv-validate">
                    <div class="form-group">
                      <label class="control-label" for="typeahead">Single Dataset <em>(Local)</em></label>
                      <div class="input-group input-group-in">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input id="typeahead" name="typeahead" class="form-control" placeholder="Look a team...">
                      </div><!-- /input-group-in -->
                    </div><!--/form-group-->

                    <div class="form-group">
                      <label class="control-label" for="tagsinput">Tags Input</label>
                      <input id="tagsinput" name="tagsinput" data-input="tags" class="form-control" value="php,ios,javascript">
                    </div><!--/form-group-->


                    <div class="form-group">
                      <label class="control-label" for="s2Dropdown">Select2 Dropdown</label><br>
                      <select name="s2Dropdown" id="s2Dropdown" style="width:100%">
                    ...
                    <div class="form-group">
                      <label class="control-label" for="s2Tags">Select2 Tags</label><br>
                      <select name="s2Tags" id="s2Tags" style="width:100%" data-tags="true" multiple="multiple">
                    ...
                    <div class="form-group">
                      <label class="control-label">SelectBoxIt</label>
                      <select id="selectboxit" name="selectboxit">
